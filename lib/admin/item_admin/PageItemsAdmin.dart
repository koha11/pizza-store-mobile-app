            ...
            body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  controller.isLoadingItem ? const Center(
                                      ...
                                      child: Row(
                                        children: [
                                          IconButton(
                                            ...
                                            color: Colors.blue,
                                            onPressed:() => showUpdateItemDialog(context, item), //sửa
                                          ),
                                          IconButton(
                                            icon: const Icon(Icons.delete),
                                            color: Colors.red,
                                            onPressed:() async{
                                              await controller.confirmAndRemoveItem(context, item);
                                            }, //xóa
                                          ),
                                        ],
                                      ),
